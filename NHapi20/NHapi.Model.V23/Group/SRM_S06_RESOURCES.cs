...
public class SRM_S06_RESOURCES : AbstractGroup {
    ...
    /// <summary>   Creates a new SRM_S06_RESOURCES Group. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SRM_S06_GENERAL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SRM_S06_LOCATION_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SRM_S06_PERSONNEL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
