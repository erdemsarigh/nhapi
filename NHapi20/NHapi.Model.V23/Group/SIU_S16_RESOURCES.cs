...
public class SIU_S16_RESOURCES : AbstractGroup {
    ...
    /// <summary>   Creates a new SIU_S16_RESOURCES Group. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SIU_S16_GENERAL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SIU_S16_LOCATIONL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ///
    /// <returns>   The locationl resource. </returns>
    ...
    /// <summary>   Gets the locationl resource repetitions used. </summary>
    ///
    /// <value> The locationl resource repetitions used. </value>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SIU_S16_PERSONNEL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
