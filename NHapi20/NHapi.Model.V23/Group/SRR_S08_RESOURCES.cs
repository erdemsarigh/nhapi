...
public class SRR_S08_RESOURCES : AbstractGroup {
    ...
    /// <summary>   Creates a new SRR_S08_RESOURCES Group. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SRR_S08_GENERAL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SRR_S08_LOCATION_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SRR_S08_PERSONNEL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
