...
public class PTH : AbstractSegment  {
    ...
    /// <summary>   Returns Pathway Lifecycle Status(PTH-5). </summary>
    ///
    /// <value> The pathway lifecycle status. </value>
    ...
    /// <summary>   Returns Change Pathway Lifecycle Status Date/Time(PTH-6). </summary>
    ///
    /// <value> The change pathway lifecycle status date time. </value>
