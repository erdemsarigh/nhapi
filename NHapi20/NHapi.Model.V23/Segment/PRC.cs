...
public class PRC : AbstractSegment  {
    ...
    /// <summary>   Returns Primary Key Value(PRC-1). </summary>
    ///
    ...
    /// <summary>
    /// Returns a single repetition of Facility ID(PRC-2). throws HL7Exception if the repetition
    /// number is invalid.
    /// </summary>
    ///
  ...
  /// <summary> Returns all repetitions of Facility ID (PRC-2). </summary>
  ///
  /// <exception cref="Exception">  Thrown when an exception error condition occurs. </exception>
  ///
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Facility ID (PRC-2). </summary>
  ///
