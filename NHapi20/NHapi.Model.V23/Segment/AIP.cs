...
public class AIP : AbstractSegment  {
    ...
    /// <summary>   Returns Personnel Resource ID(AIP-3). </summary>
    ///
    /// <value> The identifier of the personnel resource. </value>
    ...
    /// <summary>
    /// Returns a single repetition of Resource Group(AIP-5). throws HL7Exception if the repetition
    /// number is invalid.
    /// </summary>
    ///
  ...
  /// <summary> Returns all repetitions of Resource Group (AIP-5). </summary>
  ///
  /// <exception cref="Exception">  Thrown when an exception error condition occurs. </exception>
  ///
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Resource Group (AIP-5). </summary>
  ///
