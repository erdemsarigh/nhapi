...
public class MRG : AbstractSegment  {
    ...
    /// <summary>
    /// Returns a single repetition of Prior Patient ID - Internal(MRG-1). throws HL7Exception if the
    ...
    ///
    /// <returns>   The prior patient identifier internal. </returns>
  ...
  /// <summary> Returns all repetitions of Prior Patient ID - Internal (MRG-1). </summary>
  ///
  /// <exception cref="Exception">  Thrown when an exception error condition occurs. </exception>
  ///
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Prior Patient ID - Internal (MRG-1). </summary>
  ///
  /// <value>   The prior patient identifier internal repetitions used. </value>
...
get{
    ...
    /// <summary>   Returns Prior Patient Name(MRG-7). </summary>
    ///
    /// <value> The name of the prior patient. </value>
