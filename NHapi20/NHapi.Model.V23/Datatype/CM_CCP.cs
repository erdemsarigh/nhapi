...
{
/// <summary>
/// <p>The HL7 CM_CCP (channel calibration parameters) data type.  Consists of the following
/// components: </p><ol>
...
public class CM_CCP : AbstractType, IComposite{
    ...
    /// <summary>   Creates a CM_CCP. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns Sensitivity correction factory (component #0).  This is a convenience method that
    /// saves you from casting and handling an exception.
    /// </summary>
    ///
    /// <value> The sensitivity correction factory. </value>
...
get{
    ...
    /// <summary>
    /// Returns Baseline (component #1).  This is a convenience method that saves you from casting
...
get{
    ...
    /// <summary>
    /// Returns Time skew (component #2).  This is a convenience method that saves you from casting
    /// and handling an exception.
    /// </summary>
    ///
    /// <value> The time skew. </value>
