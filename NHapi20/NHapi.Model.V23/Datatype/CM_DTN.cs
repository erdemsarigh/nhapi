...
{
/// <summary>
/// <p>The HL7 CM_DTN (Day Type and Number) data type.  Consists of the following components:
/// </p><ol>
/// <li>day type (IS)</li>
...
get{
    ...
    /// <summary>
    /// Returns day type (component #0).  This is a convenience method that saves you from casting
