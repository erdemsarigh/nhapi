...
{
/// <summary>
/// <p>The HL7 XCN (Extended Composite ID number and name (2.8.46)) data type.  Consists of the
...
get{
    ...
    /// <summary>
    /// Returns name type (component #9).  This is a convenience method that saves you from casting
    /// and handling an exception.
    /// </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns assigning facility ID (component #13).  This is a convenience method that saves you
    /// from casting and handling an exception.
    /// </summary>
    ///
