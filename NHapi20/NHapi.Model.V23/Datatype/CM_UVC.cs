...
{
/// <summary>
/// <p>The HL7 CM_UVC (Value code and amount) data type.  Consists of the following components:
/// </p><ol>
/// <li>value code (IS)</li>
...
get{
    ...
    /// <summary>
    /// Returns value code (component #0).  This is a convenience method that saves you from casting
