...
{
/// <summary>
/// <p>The HL7 DR (Date Time Range (2.8.12)) data type.  Consists of the following components:
/// </p><ol>
...
get{
    ...
    /// <summary>
    /// Returns range start date/time (component #0).  This is a convenience method that saves you
    /// from casting and handling an exception.
    /// </summary>
    ///
    /// <value> The range start date time. </value>
...
get{
    ...
    /// </summary>
    ///
    /// <value> The range end date time. </value>
