...
get{
    ...
    ///  * (Pricing) - creates it if necessary throws HL7Exception if the repetition requested is
    ///  more than one
    ...
    /// <summary>   Gets the prc repetitions used. </summary>
    ///
    /// <value> The prc repetitions used. </value>
