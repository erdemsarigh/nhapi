...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SIU_S12_GENERAL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SIU_S12_LOCATION_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of SIU_S12_PERSONNEL_RESOURCE (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
