...
public class OM1 : AbstractSegment  {
    ...
    ///
    /// <value> The identifier of the producer s service test observation. </value>
...
get{
    ...
    ///
    /// <value> The other service test observation i ds for the observation. </value>
...
get{
    ...
    ///
    /// <value> The portable device indicator. </value>
...
get{
    ...
    ///
    /// <value> The nature of service test observation. </value>
...
get{
    ...
    /// <summary>
    /// Returns a single repetition of Service/Test/Observation Performance Schedule(OM1-40). throws
    /// HL7Exception if the repetition number is invalid.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ...
    /// <param name="rep">  The repetition number (this is a repeating field) </param>
    ///
    /// <returns>   The service test observation performance schedule. </returns>
 ...
 return ret;
  ...
  /// </summary>
  ///
  /// <value>   The service test observation performance schedule repetitions used. </value>
