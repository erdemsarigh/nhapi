...
get{
    ...
    /// <summary>
    /// Returns a single repetition of Value Amount and Code(UB2-6). throws HL7Exception if the
    /// repetition number is invalid.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ...
    /// <param name="rep">  The repetition number (this is a repeating field) </param>
    ///
    /// <returns>   The value amount code. </returns>
  ...
  /// <summary> Returns all repetitions of Value Amount and Code (UB2-6). </summary>
  ///
  /// <exception cref="Exception">  Thrown when an exception error condition occurs. </exception>
  ///
  /// <returns> An array of uvc. </returns>
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Value Amount and Code (UB2-6). </summary>
  ///
  /// <value>   The value amount code repetitions used. </value>
...
get{
    ...
    /// <param name="rep">  The repetition number (this is a repeating field) </param>
    ///
    /// <returns>   The occurrence code date 3235. </returns>
  ...
  /// <exception cref="Exception">  Thrown when an exception error condition occurs. </exception>
  ///
  /// <returns> An array of ocd. </returns>
 ...
 return ret;
  ...
  ///
  /// <value>   The occurrence code date 3235 repetitions used. </value>
...
get{
    ...
    /// <summary>
    /// Returns a single repetition of Occurrence Span Code/Dates (36)(UB2-8). throws HL7Exception if
  ...
  /// <exception cref="Exception">  Thrown when an exception error condition occurs. </exception>
  ///
  /// <returns> An array of osp. </returns>
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Occurrence Span Code/Dates (36) (UB2-8). </summary>
  ///
...
get{
    ...
    /// <summary>
    /// Returns a single repetition of Document Control Number(UB2-12). throws HL7Exception if the
    /// repetition number is invalid.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Document Control Number (UB2-12). </summary>
  ///
...
get{
    ...
    ///
    /// <value> The number of special visits. </value>
