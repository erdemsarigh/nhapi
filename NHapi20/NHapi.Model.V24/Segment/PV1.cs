...
get{
    ...
    /// <summary>
    /// Returns a single repetition of Discharge Date/Time(PV1-45). throws HL7Exception if the
    /// repetition number is invalid.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ...
    /// <param name="rep">  The repetition number (this is a repeating field) </param>
    ///
    /// <returns>   The discharge date time. </returns>
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Discharge Date/Time (PV1-45). </summary>
  ///
  /// <value>   The discharge date time repetitions used. </value>
