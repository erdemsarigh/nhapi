...
{
/// <summary>
/// Represents a MFQ_M01 message structure (see chapter 8). This structure contains the following
/// elements:
/// <ol>
...
public class MFQ_M01 : AbstractMessage  {
    ...
    /// <summary>   Creates a new MFQ_M01 Group with custom IModelClassFactory. </summary>
    ///
