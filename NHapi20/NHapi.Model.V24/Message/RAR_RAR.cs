...
{
/// <summary>
/// Represents a RAR_RAR message structure (see chapter 4). This structure contains the following
/// elements:
/// <ol>
...
public class RAR_RAR : AbstractMessage  {
    ...
    /// <summary>   Creates a new RAR_RAR Group with custom IModelClassFactory. </summary>
    ///
