...
{
/// <summary>
/// Represents a QRY_Q01 message structure (see chapter 5). This structure contains the following
/// elements:
/// <ol>
...
public class QRY_Q01 : AbstractMessage  {
    ...
    /// <summary>   Creates a new QRY_Q01 Group with custom IModelClassFactory. </summary>
    ///
