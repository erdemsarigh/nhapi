...
{
/// <summary>
/// Represents a MFN_M01 message structure (see chapter 8). This structure contains the following
/// elements:
/// <ol>
...
public class MFN_M01 : AbstractMessage  {
    ...
    /// <summary>   Creates a new MFN_M01 Group with custom IModelClassFactory. </summary>
    ///
