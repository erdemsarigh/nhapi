...
{
/// <summary>
/// Represents a RSP_K23 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class RSP_K23 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RSP_K23 Group with custom IModelClassFactory. </summary>
    ///
