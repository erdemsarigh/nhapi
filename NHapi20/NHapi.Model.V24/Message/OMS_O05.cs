...
{
/// <summary>
/// Represents a OMS_O05 message structure (see chapter 4). This structure contains the following
/// elements:
/// <ol>
...
public class OMS_O05 : AbstractMessage  {
    ...
    /// <summary>   Creates a new OMS_O05 Group with custom IModelClassFactory. </summary>
    ///
