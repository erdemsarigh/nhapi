...
{
/// <summary>
/// Represents a RDS_O13 message structure (see chapter 4). This structure contains the following
/// elements:
/// <ol>
...
public class RDS_O13 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RDS_O13 Group with custom IModelClassFactory. </summary>
    ///
