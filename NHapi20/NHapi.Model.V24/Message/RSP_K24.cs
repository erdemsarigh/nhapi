...
{
/// <summary>
/// Represents a RSP_K24 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class RSP_K24 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RSP_K24 Group with custom IModelClassFactory. </summary>
    ///
