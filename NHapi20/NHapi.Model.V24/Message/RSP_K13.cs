...
{
/// <summary>
/// Represents a RSP_K13 message structure (see chapter 5). This structure contains the following
/// elements:
/// <ol>
...
public class RSP_K13 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RSP_K13 Group with custom IModelClassFactory. </summary>
    ///
