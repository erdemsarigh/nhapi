...
{
/// <summary>
/// Represents a MFK_M01 message structure (see chapter 8). This structure contains the following
/// elements:
/// <ol>
...
get{
    ...
    ///  * (Master File Acknowledgment) - creates it if necessary throws HL7Exception if the
