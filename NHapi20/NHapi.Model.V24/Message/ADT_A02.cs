...
{
/// <summary>
/// Represents a ADT_A02 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class ADT_A02 : AbstractMessage  {
    ...
    /// <summary>   Creates a new ADT_A02 Group with custom IModelClassFactory. </summary>
    ///
