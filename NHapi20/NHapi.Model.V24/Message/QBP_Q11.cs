...
{
/// <summary>
/// Represents a QBP_Q11 message structure (see chapter 5). This structure contains the following
/// elements:
/// <ol>
...
public class QBP_Q11 : AbstractMessage  {
    ...
    /// <summary>   Creates a new QBP_Q11 Group with custom IModelClassFactory. </summary>
    ///
