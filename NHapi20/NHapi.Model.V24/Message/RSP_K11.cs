...
{
/// <summary>
/// Represents a RSP_K11 message structure (see chapter 5). This structure contains the following
/// elements:
/// <ol>
...
public class RSP_K11 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RSP_K11 Group with custom IModelClassFactory. </summary>
    ///
