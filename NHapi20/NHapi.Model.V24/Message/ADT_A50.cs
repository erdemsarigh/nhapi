...
{
/// <summary>
/// Represents a ADT_A50 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class ADT_A50 : AbstractMessage  {
    ...
    /// <summary>   Creates a new ADT_A50 Group with custom IModelClassFactory. </summary>
    ///
