...
{
/// <summary>
/// Represents a RGV_O15 message structure (see chapter 4). This structure contains the following
/// elements:
/// <ol>
...
public class RGV_O15 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RGV_O15 Group with custom IModelClassFactory. </summary>
    ///
