...
{
/// <summary>
/// Represents a RER_RER message structure (see chapter 4). This structure contains the following
/// elements:
/// <ol>
...
public class RER_RER : AbstractMessage  {
    ...
    /// <summary>   Creates a new RER_RER Group with custom IModelClassFactory. </summary>
    ///
