...
{
/// <summary>
/// Represents a ADT_A16 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class ADT_A16 : AbstractMessage  {
    ...
    /// <summary>   Creates a new ADT_A16 Group with custom IModelClassFactory. </summary>
    ///
