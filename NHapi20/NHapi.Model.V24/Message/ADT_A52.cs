...
{
/// <summary>
/// Represents a ADT_A52 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class ADT_A52 : AbstractMessage  {
    ...
    /// <summary>   Creates a new ADT_A52 Group with custom IModelClassFactory. </summary>
    ///
