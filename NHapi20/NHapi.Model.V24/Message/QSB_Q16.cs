...
{
/// <summary>
/// Represents a QSB_Q16 message structure (see chapter 5). This structure contains the following
/// elements:
/// <ol>
...
public class QSB_Q16 : AbstractMessage  {
    ...
    /// <summary>   Creates a new QSB_Q16 Group with custom IModelClassFactory. </summary>
    ///
