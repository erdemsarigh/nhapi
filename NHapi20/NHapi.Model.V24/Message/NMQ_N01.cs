...
public class NMQ_N01 : AbstractMessage  {
    ...
    /// <summary>   Creates a new NMQ_N01 Group with custom IModelClassFactory. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of NMQ_N01_CLOCK_AND_STATISTICS (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
