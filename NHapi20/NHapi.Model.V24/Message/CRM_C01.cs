...
{
/// <summary>
/// Represents a CRM_C01 message structure (see chapter 7). This structure contains the following
/// elements:
/// <ol>
...
public class CRM_C01 : AbstractMessage  {
    ...
    /// <summary>   Creates a new CRM_C01 Group with custom IModelClassFactory. </summary>
    ///
