...
{
/// <summary>
/// Represents a ADT_A18 message structure (see chapter 3). This structure contains the following
/// elements:
/// <ol>
...
public class ADT_A18 : AbstractMessage  {
    ...
    /// <summary>   Creates a new ADT_A18 Group with custom IModelClassFactory. </summary>
    ///
