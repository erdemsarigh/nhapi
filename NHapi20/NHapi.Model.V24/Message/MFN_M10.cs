...
{
/// <summary>
/// Represents a MFN_M10 message structure (see chapter 8). This structure contains the following
/// elements:
/// <ol>
...
public class MFN_M10 : AbstractMessage  {
    ...
    /// <summary>   Creates a new MFN_M10 Group with custom IModelClassFactory. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of MFN_M10_MF_TEST_BATTERIES (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ///
    /// <returns>   The mf test batteries. </returns>
    ...
    /// <summary>   Gets the mf test batteries repetitions used. </summary>
    ///
    /// <value> The mf test batteries repetitions used. </value>
