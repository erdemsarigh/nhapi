...
{
/// <summary>
/// Represents a QBP_Q15 message structure (see chapter 5). This structure contains the following
/// elements:
/// <ol>
...
public class QBP_Q15 : AbstractMessage  {
    ...
    /// <summary>   Creates a new QBP_Q15 Group with custom IModelClassFactory. </summary>
    ///
