namespace NHapi.Model.V22_ZSegments.Datatype
{
    ...
    public class ACCIDENTDATA : AbstractType, IComposite
    {
        ...
        ///</summary>
        public ACCIDENTDATA(IMessage message)
            : this(message, null)
        {
        }
        ...
        /// <param name="message">The Message to which this Type belongs</param>
        ///</summary>		
        public ACCIDENTDATA(IMessage message, string description)
            : base(message, description)
        {
            this.data = new IType[2];
            this.data[0] = new ID(message, 0, "File number");
            this.data[1] = new ST(message, "Text");
        }
        ...
        public ID Id
        {
            get
            {
                ...
                {
                    HapiLogFactory.GetHapiLog(this.GetType())
                        .Error("Unexpected problem accessing known data type component - this is a bug.", e);
