...
get{
    ...
    /// <summary>
    /// Returns  first repetition of PPR_PC1_PATHWAY_OBSERVATION (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ///
    /// <returns>   The pathway observation. </returns>
    ...
    /// <summary>   Gets the pathway observation repetitions used. </summary>
    ///
    /// <value> The pathway observation repetitions used. </value>
