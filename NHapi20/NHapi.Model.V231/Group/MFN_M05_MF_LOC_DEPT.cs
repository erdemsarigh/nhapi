...
get{
    ...
    /// <summary>
    /// Returns  first repetition of LCC (LCC - location charge code segment) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ...
    ///  * (LCC - location charge code segment) - creates it if necessary throws HL7Exception if the
