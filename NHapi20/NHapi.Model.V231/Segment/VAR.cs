...
public class VAR : AbstractSegment  {
    ...
    /// <summary>
    /// Returns a single repetition of Variance Originator(VAR-4). throws HL7Exception if the
    ...
    ///
    /// <returns>   The variance originator. </returns>
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Variance Originator (VAR-4). </summary>
  ///
  /// <value>   The variance originator repetitions used. </value>
