...
{
/// <summary>
/// <p>The HL7 NDL (observing practitioner) data type.  Consists of the following components:
/// </p><ol>
/// <li>name (CN)</li>
...
get{
    ...
    /// <summary>
    /// Returns person location type (component #8).  This is a convenience method that saves you
