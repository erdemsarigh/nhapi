...
{
/// <summary>
/// Represents a PPR_PC1 message structure (see chapter ). This structure contains the following
/// elements:
/// <ol>
...
public class PPR_PC1 : AbstractMessage  {
    ...
    /// <summary>   Creates a new PPR_PC1 Group with custom IModelClassFactory. </summary>
    ///
