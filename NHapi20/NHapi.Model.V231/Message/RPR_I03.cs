...
public class RPR_I03 : AbstractMessage  {
    ...
    /// <summary>   Creates a new RPR_I03 Group with custom IModelClassFactory. </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of PID (PID - patient identification segment) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ...
    ///  * (PID - patient identification segment) - creates it if necessary throws HL7Exception if
    ...
    /// <summary>   Gets the PID repetitions used. </summary>
    ///
    /// <value> The PID repetitions used. </value>
