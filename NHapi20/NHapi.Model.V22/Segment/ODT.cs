...
get{
    ...
    /// <summary>
    /// Returns a single repetition of Text Instruction(ODT-3). throws HL7Exception if the repetition
    /// number is invalid.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
 ...
 return ret;
  ...
  /// <summary> Returns the total repetitions of Text Instruction (ODT-3). </summary>
  ///
