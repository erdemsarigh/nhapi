...
{
/// <summary>
/// <p>The HL7 CM_DDI (daily deductible) data type.  Consists of the following components:
/// </p><ol>
/// <li>delay days (ST)</li>
/// <li>amount (NM)</li>
...
get{
    ...
    /// <summary>
    /// Returns amount (component #1).  This is a convenience method that saves you from casting and
