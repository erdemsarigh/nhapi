...
{
/// <summary>
/// <p>The HL7 CM_GROUP_ID (Auftragsgruppennummer) data type.  Consists of the following
/// components: </p><ol>
...
get{
    ...
    /// </summary>
    ///
    /// <value> The identifier of the unique group. </value>
...
get{
    ...
    /// <summary>
    /// Returns placer application id (component #1).  This is a convenience method that saves you
    /// from casting and handling an exception.
    /// </summary>
    ///
    /// <value> The identifier of the placer application. </value>
