...
{
/// <summary>
/// <p>The HL7 CM_JOB_CODE (Berufsbezeichnung) data type.  Consists of the following components:
/// </p><ol>
/// <li>job code (ID)</li>
...
get{
    ...
    /// <summary>
    /// Returns employee classification (component #1).  This is a convenience method that saves you
    /// from casting and handling an exception.
    /// </summary>
    ///
    /// <value> The employee classification. </value>
