...
get{
    ...
    /// <summary>
    /// Returns parent´s placer order number (component #0).  This is a convenience method that saves
    /// you from casting and handling an exception.
    /// </summary>
    ///
    /// <value> The parent s placer order number. </value>
...
get{
    ...
    /// <summary>
    /// Returns parent´s filler order number (component #1).  This is a convenience method that saves
    /// you from casting and handling an exception.
    /// </summary>
    ///
    /// <value> The parent s filler order number. </value>
