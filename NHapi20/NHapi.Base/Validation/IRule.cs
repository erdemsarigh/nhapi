...
namespace NHapi.Base.validation
{
    ...
    /// Previously, the only run-time message validation HAPI performs is within the setValue()
    /// methods of the Primitive datatype classes.  For example when you called setValue() on a DT an
    /// exception was thrown if the String arg was not in the correct DT format.  This method served
    /// well initially but left us with the following limitations:
    ...
    /// <li>MessageRule: Called when complete message content is to be checked on a parsed message
    /// (e.g. conformance profile). </li>
    ...
    public interface IRule
    {
        ...
        /// <summary>
        /// Returns a text description of the rule.  This description may be used as a message in
        /// exceptions generated if validation against the rule fails, or in a user interface for rule
        /// configuration.
        /// </summary>
        ///
        ...
        /// <summary>
        /// A string indicating the section of the HL7 standard from which this rule is derived (if
        /// applicable).  Like the description, this may be used in an exception message or configuration
        /// UI.
        /// </summary>
        ///
