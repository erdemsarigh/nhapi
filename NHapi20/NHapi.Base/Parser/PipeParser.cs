    ...
    public class PipeParser : ParserBase
    {
        ...
        public override ISegment GetCriticalResponseData(System.String message)
        {
            ...
            try
            {
                ...
                msh = ParserBase.MakeControlMSH(version, this.Factory);
            ...
            catch (System.Exception e)
            {
                ...
                throw new HL7Exception(
                    "Can't parse critical fields from MSH segment (" + e.GetType().FullName + ": " + e.Message + "): "
                    + mshString,
        ...
        public virtual void Parse(ISegment destination, System.String segment, EncodingCharacters encodingChars)
        {
            ...
            {
                Varies.fixOBX5(destination, this.Factory);
            }
        }
        ...
        protected internal override IMessage DoParse(System.String message, System.String version)
        {
            ...
            IMessage m = this.InstantiateMessage(structure.messageStructure, version, structure.explicitlyDefined);
            ...
            for (int i = 0; i < segments.Length; i++)
            {
                ...
                if (segments[i] != null && segments[i].Length >= 3)
                {
                    ...
                    if (dirIter.MoveNext())
                    {
                        this.Parse((ISegment)dirIter.Current, segments[i], encodingChars);
                    }
                }
            }
            return m;
        ...
        private static void Parse(IType destinationField, System.String data, EncodingCharacters encodingCharacters)
        {
            ...
            {
                System.String[] subcomponents = Split(
                    components[i],
        ...
        private MessageStructure GetStructure(System.String message)
        {
            ...
            try
            {
                System.String[] fields =
                    Split(
                        message.Substring(0, (System.Math.Max(message.IndexOf(segDelim), message.Length)) - (0)),
                        System.Convert.ToString(ec.FieldSeparator));
                ...
                else
                {
                    System.Text.StringBuilder buf =
                        new System.Text.StringBuilder("Can't determine message structure from MSH-9: ");
            ...
            {
                throw new HL7Exception(
                    "Can't find message structure (MSH-9-3): " + e.Message,
        ...
        private class AnonymousClassPredicate1 : FilterIterator.IPredicate
        {
            ...
            {
                this.InitBlock(name, enclosingInstance);
            }
