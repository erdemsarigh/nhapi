    ...
    public class Escape
    {
        ...
        public static void Main(System.String[] args)
        {
            ...
            System.Console.Out.WriteLine(
                "Time to make " + n + " times: " + ((System.DateTime.Now.Ticks - 621355968000000000) / 10000 - start));
            ...
            System.Console.Out.WriteLine(
                "Time to get " + n + " times: " + ((System.DateTime.Now.Ticks - 621355968000000000) / 10000 - start));
            start = (System.DateTime.Now.Ticks - 621355968000000000) / 10000;
            for (int i = 0; i < n; i++)
            {
                seqs = makeEscapeSequences(ec);
                    ...
                    if (specialCharacters[textAsChar[i]] != null)
                    {
                        ...
                        if (textAsChar[i].Equals(encChars.EscapeCharacter))
                        {
                            ...
                            if (i < textAsChar.Length - 1)
                            {
                                ...
                                if (_nonEscapeCharacterMapping[textAsChar[i] + textAsChar[i + 1]] != null)
                                {
