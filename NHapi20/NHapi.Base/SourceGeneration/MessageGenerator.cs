    ...
    public class MessageGenerator : System.Object
    {
        ...
        private static System.String getMessageListQuery(System.String version)
        {
            ...
            return "SELECT distinct  [message_type]+'_'+[event_code] AS msg_struct, '[AAA]'"
                   ...
                   + " where HL7Versions.hl7_version = '" + version
        ...
        private static System.String getSegmentListQuery(System.String message, System.String version)
        {
            ...
            sql = "SELECT HL7Segments.seg_code, repetitional, optional, HL7Segments.description, seq_no, groupname "
                  ...
                  + "ON HL7Segments.version_id = HL7Versions.version_id " + "WHERE (((HL7Versions.hl7_version)= '"
                  + version + "') " + "AND (([message_type]+'_'+[event_code])='" + message
