...
{
    /// <summary>
    /// Represents the category of HL7 data types that contain a single value (in other words have no
    /// subcomponents).  Examples include ST and ID.
    /// </summary>
    ...
    public interface IPrimitive : IType
    {
        ...
        ///
        /// <summary>
        /// Sets the value of this field if the given value is legal in the context of the implementing
        /// class.
        /// </summary>
        ///
