...
namespace NHapi.Base.Model
{
    ...
    public interface ISegment : IStructure
    {
        ...
        /// <summary>
        /// Returns the array of Fields at the specified index.  The array will be of length 1 for non-
        /// repeating fields, and >1 for repeating fields.  Fields are numbered from 1.
        /// </summary>
        ///
        ...
        /// three are needed, the third can be created and accessed using the following code: &lt;br&gt;
        /// <code>Type t = GetField(x, 2);</code>
        /// </summary>
        ///
        /// <summary>
        /// repetition is more than 1 greater than the highest index of existing repetitions.  
        /// NOTE: to facilitate local extensions, no exception is thrown if rep > max cardinality.
        /// </summary>
        ///
        /// <param name="number">   the field number. </param>
        ...
        /// The current cardinality can be obtained by checking the length of the array returned by
        /// GetLength(n).  
        /// </summary>
        ///
        /// <param name="number">   the field number. </param>
