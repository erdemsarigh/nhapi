...
namespace NHapi.Base.Model.Primitive
{
    ...
    /// <summary>
    /// Represents an HL7 timestamp, which is related to the HL7 TS type.  In version 2.5, TS is a
    /// composite type.  The first component is type DTM, which corresponds to this class (actually
    /// Model.v25.datatype.DTM inherits from this class at time of writing).  In HL7 versions 2.2-2.4,
    /// it wasn't perfectly clear whether TS was composite or primitive.  HAPI interprets  
    /// it as composite, with the first component having a type that isn't defined by HL7, and we
    /// call this type TSComponentOne.  In v2.1, TS is primitive, and corresponds one-to-one with
    /// this class.
    /// </summary>
    ...
    public class TSComponentOne : AbstractPrimitive
    {
        ...
        /// <summary>   Initializes a new instance of the TSComponentOne class. </summary>
        ///
        ...
        /// </summary>
        ///
        /// <value> The long date time format. </value>
        ...
        /// <summary>
        /// Used for setting the format of a long date (Year, Month, Day, Hour, Minute, Second, Fraction
        /// of second)
        /// </summary>
        ///
        /// <value> The long date time format with faction of second. </value>
        ...
        /// </summary>
        ///
        /// <value> The long date time format with second. </value>
        ...
        /// <summary>   Used for setting the format of a short date (Year, Month, Day) </summary>
        ///
        /// <value> The short date time format. </value>
        ...
        /// <summary>   Get the value as a date.  Throws hl7Exception if error. </summary>
        ///
        ...
        /// <summary>   Sets the value (to the format specified) using a date. </summary>
        ///
        /// <exception cref="HL7Exception"> Thrown when a HL 7 error condition occurs. </exception>
        ///
        ...
        /// <summary>   Set the value as a long date. </summary>
        ///
        ...
        /// <summary>   Set the value as a lond date with fraction of second. </summary>
        ///
        /// <param name="value">    . </param>
        ...
        /// <summary>   Set the value as a lond date with second. </summary>
        ///
        /// <param name="value">    . </param>
        ...
        /// <summary>   Set the value as a short date. </summary>
        ///
        /// <param name="value">    . </param>
