...
{
/// <summary>
/// Represents the DFT_P03_FINANCIAL_COMMON_ORDER Group.  A Group is an ordered collection of
/// message
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) - creates it
    /// if necessary.
    /// </summary>
    ///
...
get{
    ...
    /// <summary>
    /// Returns  first repetition of DFT_P03_FINANCIAL_OBSERVATION (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
