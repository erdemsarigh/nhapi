...
get{
    ...
    /// <summary>
    /// Returns  first repetition of DFT_P11_TIMING_QUANTITY (a Group object) - creates it if
    /// necessary.
    /// </summary>
    ///
    /// <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
    ///
    /// <returns>   The timing quantity. </returns>
    ...
    /// <summary>   Gets the timing quantity repetitions used. </summary>
    ///
    /// <value> The timing quantity repetitions used. </value>
